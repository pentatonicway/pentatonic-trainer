...
import { getInterval, transposeNote } from '../utils/transpose'
 ...
 * where every box should get a fresh auto-resolved index).
 */
...
type SessionState = {
  ...
  originalRoots: NoteRoot[]  // roots from the loaded preset, before transposing
...
export const useSessionStore = create<SessionState & SessionActions>((set, get) => ({
  ...
  loadPreset(preset) {
    set(state => {
      // Recalculate all shapeIndexes fresh
