...
export function Session() {
  ...
  const currentProgressionName = useSessionStore(
    (s) => s.currentProgressionName
  );
  const currentSearchTerm = useSessionStore((s) => s.currentSearchTerm);
        ...
        >
          <span
            style={{
              fontSize: 16,
              fontWeight: 700,
              color: themeKey === "light" ? "#000000" : "#FFFFFF",
              ...
              {[
                {
                  ...
                  url: `https://www.ultimate-guitar.com/search.php?search_type=title&value=${encodeURIComponent(
                    currentSearchTerm
                  )}`,
                },
                {
                  label: "Chordify",
                  url: `https://chordify.net/search/${encodeURIComponent(
                    currentSearchTerm
                  )}`,
                },
                {
                  label: "E-Chords",
                  url: `https://www.e-chords.com/search-chord/${encodeURIComponent(
                    currentSearchTerm
                  )}`,
                },
              ].map(({ label, url }, i) => (
                ...
                >
                  {i > 0 && (
                    <span
                      style={{ color: themeKey === "light" ? "#999" : "#666" }}
                    >
                      ·
                    </span>
                  )}
                  <a
                    ...
                    style={{
                      fontSize: 12,
                      fontWeight: 600,
                      color: themeKey === "light" ? "#6B46C1" : "#F6A623",
                      textDecoration: "none",
